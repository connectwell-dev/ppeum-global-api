...
// 공용언어(ko) 번역 수정 - 전체 옵션
export class PutProductDetailInfoPublicTranslationReqDto extends SetProductDetailInfoTranslationDto {
...
// 기타언어 번역 수정 - 전체 옵션
export class PutProductDetailInfoTranslationReqDto extends SetProductDetailInfoTranslationDto {
